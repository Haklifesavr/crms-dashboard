...
DEBUG = os.environ.get("DEBUG", 'False').lower() in ['false', 'yes', '1']


# https://docs.djangoproject.com/en/dev/ref/settings/#allowed-hosts
# ALLOWED_HOSTS = ["localhost", "0.0.0.0", "127.0.0.1"]
# ALLOWED_HOSTS = ["https://dashboard.marketingteam.app/"]
...
CORS_ALLOWED_ORIGINS = [
    "http://127.0.0.1:3000",
    "http://127.0.0.1:8000",
    "https://crm-django-sz3c6uf2gq-uc.a.run.app",
    "https://crm-frontend-dot-mythical-maxim-417716.ue.r.appspot.com"
]
...
if ENVIRONMENT == "production":
    # Google Cloud PostgreSQL database for production
    DATABASES = {
        'default': {
...
EMAIL_BACKEND = os.environ.get("EMAIL_SMTP")
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://crm-django-sz3c6uf2gq-uc.a.run.app",
    "https://crm-frontend-dot-mythical-maxim-417716.ue.r.appspot.com"
    # "https://dashboard.marketingteam.app",
]
